...
class Achievernavbar extends StatefulWidget {
  const Achievernavbar({Key? key}) : super(key: key);

  @override
  State<Achievernavbar> createState() => _AchievernavbarState();
}

class _AchievernavbarState extends State<Achievernavbar> {
  int _CurrentIndex=2;
  final List screens=[
    Course(),
    Library(),
