...
class _PythonCourseState extends State<PythonCourse> {
  final Uri _url=Uri.parse('https://www.youtube.com/watch?v=7wnove7K-ZQ&list=PLu0W_9lII9agwh1XjRt242xIpHhPT2llg');
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Image(image: AssetImage('assets/images/pythoncrashcourse.jpg'),gaplessPlayback: true,
                  fit: BoxFit.cover,filterQuality: FilterQuality.low,colorBlendMode:BlendMode.lighten,
                  ...
                  Align(
                    ...
                    child: Text('Basics of Python with Data Structures and Algorithms',style: TextStyle(
                      fontSize: 30,
                      fontWeight: FontWeight.bold,
                      //fontFamily: 'Sedgwick',
                      letterSpacing:0,
                  ...
                  Container(
                    ...
                    child: Text('This is the course to pick if you are just getting into'
                        ' coding and want to build a strong foundation. Widely used in Data '
                        'Science & Machine Learning',style: TextStyle(
                      fontSize: 25,
                      fontWeight: FontWeight.w300
                    ),),
                  ),
                 ...
                 Padding(padding: EdgeInsets.all(20)),
                 Image(image: NetworkImage('https://files.codingninjas.com/cdn-cgi/image/width=434/python-10821.png'),),
                 Padding(padding: EdgeInsets.all(20)),
                 ElevatedButton(
                   style: ButtonStyle(backgroundColor:MaterialStatePropertyAll(Colors.deepOrange),elevation:MaterialStatePropertyAll(50),
                   shadowColor: MaterialStatePropertyAll(Colors.purple)),
                   onPressed: (){
                     _launchURl();
                   },
                   child: Text('Enroll Now',style: TextStyle(fontSize: 45),),
                 ),
                  Padding(padding: EdgeInsets.all(20)),
                  //Padding(padding: EdgeInsets.all(20)),
                  Divider(
